...
- 自动识别 DeepSeek 和 GLM
- 展示当前上下文使用量
- 展示会话累计 input、output 和 cache Token
- DeepSeek 展示账户余额
...
```text
DeepSeek V3 │ ctx 410.0k/1.0m 41% │ in 1.8m · out 62.3k · cache 5.2m/320.0k │ balance ¥38.52
```

GLM：

```text
GLM-5 │ ctx 370.0k/1.0m 37% │ in 1.2m · out 51.0k · cache 3.8m/281.0k │ 5h 27% · week 41% · reset 07-12 18:00
```

其他模型：

```text
Claude Sonnet │ ctx 250.0k/1.0m 25% │ in 820.0k · out 44.0k · cache 2.1m/210.0k
```
