...
```text
DeepSeek V3 │ Context 88% left │ usage 76.5k (73.2k↑ 3.3k↓) │ cache 93.8% │ balance ¥38.50
```

GLM：

```text
GLM-5 │ Context 88% left │ usage 76.5k (73.2k↑ 3.3k↓) │ cache 93.8% │ 5h 100% left · week 59% left · reset 07-12 18:00
```
